...
var Parser = function (options) {
  ...
  if (typeof options === 'object') {
    ...
    self.options.enableEtt = (options.hasOwnProperty('enableEtt') && options.enableEtt)
    self.options.enableParseISO6937 = (options.hasOwnProperty('enableParseISO6937') && options.enableParseISO6937)
  } else {
    self.options.passThru = false
    self.options.enableEtt = false
